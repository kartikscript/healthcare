...
const RegisterForm = ({user}:{user:User}) => {
    ...
    async function onSubmit(values: z.infer<typeof PatientFormValidation>) {
      ...
      if(values.identificationDocument && values.identificationDocument.length>0){
          //BLOB Is a special version of file which can be read by browser
          //extracting the file to upload
          const blobFile = new Blob([values.identificationDocument[0]],{//passing the content of file
            type: values.identificationDocument[0].type,//file type like image/png, app/pdf
          })
          //now adding the key value pairs by append in formData object
